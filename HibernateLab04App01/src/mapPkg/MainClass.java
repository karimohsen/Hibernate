...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        SessionFactory fact = new org.hibernate.cfg.Configuration().configure("hibernate1.cfg.xml").buildSessionFactory();
        ...
        buyerbid.setId(new BuyerBidProductId(5,3));
        ...
        //====================buyer_buy_product=======================
        BuyerBuyProduct buyerbuy = new BuyerBuyProduct();
        buyerbuy.setId(new BuyerBuyProductId(5,3));
